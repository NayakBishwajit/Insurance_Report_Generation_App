...
public class DataLoader implements ApplicationRunner {
	...
	public void run(ApplicationArguments args) throws Exception {
		...
		c10.setCitizenName("Alexaperry");
		c10.setGender("Fe-Male");
		c10.setPlanName("Food");
		c10.setPlanStatus("Approved");
		c10.setPlanStartDate(LocalDate.now());
		c10.setPlanEndDate(LocalDate.now().plusMonths(6));
		c10.setBenifitAmount(9000.0);

		// Food-11 plan data
		CitizenPlan c11 = new CitizenPlan();
		c11.setCitizenName("Nikki");
		...
		c13.setBenifitAmount(4000.0);

		// Medical-14 plan data
		CitizenPlan c14 = new CitizenPlan();
		c14.setCitizenName("Riyan");
		c14.setGender("Male");
		...
		c16.setBenifitAmount(4000.0);

		// Medical-17 plan data
		CitizenPlan c17 = new CitizenPlan();
		c17.setCitizenName("Sarapova");
		...
		c19.setBenifitAmount(8000.0);

		// Employment-20 plan data
		CitizenPlan c20 = new CitizenPlan();
		c20.setCitizenName("Duplesis");
		c20.setGender("Male");
		...
		c22.setBenifitAmount(6000.0);

		// Employment-23 plan data
		CitizenPlan c23 = new CitizenPlan();
		c23.setCitizenName("Jeniffer");
